...
class PshMonitoringTable extends BaseWidget
{
    ...
    public function table(Table $table): Table
    {
        ...
        return $table
            ...
            ->description('Monitoring seluruh tahapan proses Pengajuan PSH sesuai periode yang dipilih')
            ->query(
                PengajuanPsh::query()
                    ->with([
                        'satker',
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('disposisiKasubbid.waktu_disposisi')
                    ->label('Disposisi Kasubbid')
                    ->dateTime('d/m/Y H:i')
                    ->placeholder('-'),

                Tables\Columns\TextColumn::make('penugasanPshes')
                    ->label('Personel Ditunjuk')
                    ->state(
                        fn (PengajuanPsh $record): string =>
                            $record->penugasanPshes
                                ->map(
                                    fn ($penugasan) =>
